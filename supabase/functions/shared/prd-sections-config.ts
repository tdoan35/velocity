...
export function initializePRDSections(): PRDSection[] {
  ...
  const sectionTemplates: Record<string, { html: string; text: string }> = {
    'overview': {
      html: `<h3>Vision</h3><p class="template-placeholder">What is your app's core vision?</p><h3>Problem</h3><p class="template-placeholder">What problem does it solve?</p><h3>Target Users</h3><p class="template-placeholder">Who are your target users?</p>`,
    ...
    'ui_design_patterns': {
      html: `<h3>Design System</h3><p class="template-placeholder">Define your visual design approach</p><h3>Component Patterns</h3><p class="template-placeholder">Describe UI component patterns</p><h3>Accessibility</h3><p class="template-placeholder">Accessibility requirements</p>`,
    ...
    'ux_flows': {
      html: `<h3>User Journeys</h3><p class="template-placeholder">Map key user flows</p><h3>Navigation Structure</h3><p class="template-placeholder">Define app navigation</p><h3>Interaction Patterns</h3><p class="template-placeholder">Describe user interactions</p>`,
    ...
    'technical_architecture': {
      html: `<h3>Platforms</h3><p class="template-placeholder">Target platforms (iOS, Android, Web)</p><h3>Tech Stack</h3><p class="template-placeholder">Frontend, backend, database technologies</p><h3>Architecture Pattern</h3><p class="template-placeholder">System architecture approach</p><h3>Security</h3><p class="template-placeholder">Security considerations</p>`,
    ...
    'tech_integrations': {
      html: `<h3>Third-Party Services</h3><p class="template-placeholder">External APIs and services</p><h3>Authentication</h3><p class="template-placeholder">Auth providers and methods</p><h3>Environment Configuration</h3><p class="template-placeholder">Environment variables and config</p>`,

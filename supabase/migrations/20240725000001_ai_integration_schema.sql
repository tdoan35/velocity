...
-- This migration creates tables for AI code generation, caching, and conversation management
...
-- Index for efficient cleanup queries (without WHERE clause)
CREATE INDEX idx_rate_limit_cleanup ON rate_limit_logs(created_at);

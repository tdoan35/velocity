...
('velocity_production', 'frame-src', '''self'' https://appetize.io https://*.appetize.io', 'production', 'Allow frames from Appetize.io for mobile previews'),
...
('velocity_development', 'frame-src', '''self'' localhost:* http://localhost:* https://localhost:* https://appetize.io https://*.appetize.io', 'development', 'Allow local frames and Appetize.io'),
...
('velocity_staging', 'frame-src', '''self'' https://appetize.io https://*.appetize.io', 'staging', 'Allow staging frames and Appetize.io'),

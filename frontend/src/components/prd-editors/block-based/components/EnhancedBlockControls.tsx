...
export function EnhancedBlockControls({ editor, containerRef, sectionId, onContentDragStart, onContentDragEnd, onBlockInsert }: BlockControlsProps) {
  ...
  // Legacy drag store removed - now handled by @dnd-kit
  ...
  const handleDragStart = useCallback((e: DragEvent) => {
    ...
    // Legacy drag store call removed - now handled by @dnd-kit
  ...
  }, [hoveredBlock, editor, sectionId, onContentDragStart])
  ...
  const handleDragEnd = useCallback((e: DragEvent) => {
    ...
    // Legacy drag store reset removed - now handled by @dnd-kit
  ...
  }, [hoveredBlock, editor, onContentDragEnd])
